...
//        response.prettyPrint();
        ...
        Object a = json.getList("findAll{it.title=='delectus aut autem'}.id").get(0);//title i su olanin bana id sini ver. COK ÖNEMLI ID ye ulasiyoiriz. binlerce bilgi icinden.
