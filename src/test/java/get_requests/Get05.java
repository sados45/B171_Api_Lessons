...
public class Get05 extends PetStoreBaseUrl {
    ...
    //Do assertion
        ...
        response
                ...
                .body("id", hasItem(9898))//buradaki hasItem 9898 nolu datayi bulmak icin Hamcrest Matchers  // metotlarindan bodydeki bilgiyi bulmak icin kullanilan bir bilgidir.
